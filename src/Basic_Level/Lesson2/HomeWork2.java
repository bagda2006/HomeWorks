...
import java.util.function.Function;
    ...
    public class HomeWork2 {
         ...
         */
        public static class LoginValidationExeception extends Exception{}
        public static void validateLogin(String login) throws LoginValidationExeception{
            //Место для Вашего кода из пункта 2
            String regex = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[_])[A-Za-z\\d_]{1,20}$";
            //^ - начало строки , $ - конец строки
            //() - открываем "наш фильтр",[] - задаваемый диапазон символов,цифр
            //*[a-z] - проверка на содержание как минимум одной маленькой латинской буквы
            //*[A-Z] - проверка на содержание как минимум одной большой латинской буквы
            //*\d - проверка на содержание как минимум одной цифры
            //*[_] - проверка на содержание как минимум одного нижнего подчеркивания
            //A-Za-z\\d_ - объединение нужных диапазонов
            //{1,20} - кол-во символов
            if (!login.matches(regex)){
                throw new LoginValidationExeception();
            }
        }
        ...
        public static Boolean isLoginValid(String login) {
            ...
            try {
                validateLogin(login);
                return true;
            }catch (LoginValidationExeception e){
                return false;
            }
        }
